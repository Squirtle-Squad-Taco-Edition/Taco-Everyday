    ...
    <>
      ...
      <div className="groupBox">
        ...
        <div id="buttonDiv">
          ...
          <button style={{ border: 'none', borderRadius: '5px', cursor: 'pointer' }} aria-label="Send Message" type="submit" onClick={() => { socket.emit('chat message', message); void postMessage() }}>
            Submit
          </button>
        </div>
      </div>
